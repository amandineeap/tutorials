...
describe('Our first test suite', () =>{
    ...
    it('first test', () => {
        ...
        // The most receommended way by Cypress
   ...
   it('second test', () => {
       ...
       cy.contains('Sign in') // uses the first element found
   ...
   it('radio button', () => {
    ...
    it('Tooltip', () => {
        ...
        cy.get('[nbtooltip="This is a tooltip"]').should('exist')
    })
    ...
    it('Dialog box', () => {
        ...
        // 1 - bad way to access the browser window
        ...
        // 2 - good way
        // const stub = cy.stub() // if the window did not show, this would be empty
        // cy.on('window:confirm', stub) // assign event result to stub
        // cy.get('tbody tr').first().children('.nb-trash').click().then(() => {
        //     expect(stub.getCall(0)).to.be.calledWith('Are you sure you want to delete?')
        // })

        // 3
        cy.get('tbody tr').first().find('.nb-trash').click()
        cy.on('window:confirm', () => false) // prevents actually deleting
    })
