...
var interfaces_1 = __importStar(require("./src/interfaces"));

var isOpen = false;
var myName = 'amandine';
var myAge = 32;
var list = [0, 1, 2];
var me = ['Scott', 32, false]; // enum Job {
//   WebDev,
//   WebDesigner,
//   PM,
// }
...
console.log(makeMargin(10)); // null types
...
console.log(interfaces_1.Type.Video); // enum Type2 {
//   Video = 'Video',
//   BlogPost = 'Blog',
//   Quiz = 'Quiz',
// }
...
console.log(interfaces_1["default"].Quiz); // classes
// public
...
redWings.score();
console.log(redWings.teamName); // modules
},{"./src/interfaces":"src/interfaces.ts"}],"../../../../.nvm/versions/node/v9.11.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
